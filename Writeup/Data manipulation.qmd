...
**Page by Region**: This page allows users to select a specific month-year to analyze the distribution of loans and deposits across Peru. Users can also choose to include or exclude the Lima region to tailor their analysis. Value boxes summarize key metrics, such as the sum of loans and deposits and the number of financial institutions. Maps for Loans and Deposits are visualized using Altair, allowing users to view the distribution of financial metrics by region.

**Page by Industry**: This page explores financial inclusion metrics broken down by industry category. Users can choose the date and choose whether to include or exclude personal/mortgage loans. Value boxes provide insights into loans, debtors, and financial institution counts by industry. Visuals include a pie chart for total loans by industry and a scatter plot comparing loan sizes to the number of debtors per industry category.
